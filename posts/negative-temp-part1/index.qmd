---
title: "Negative temperature: going below absolute zero, in a sense"
description: >
...
in our grid, as in the figure above. Then, the magnets will 
tend to orient themselves in the same direction as the magnetic field. This is the lowest-energy state: 
all magnets facing upward. We know the entropy of this state is exactly 0. So what is the energy?
...
to the magnetic field. The second equation shows that the total energy of the grid of magnets
...
In our system it would seem temperature is not super relevant. How does it
